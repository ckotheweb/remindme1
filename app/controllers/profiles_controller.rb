class ProfilesController < ApplicationController
  ...
  def new
    @profile = Profile.new
    @profile.user_id = current_user.id #creates profile with the same id as initial account (in devise) has
  end
  ...
  private
    ...
    def profile_params
      params.require(:profile).permit(:name, :lastname, :age, :user_id, :timezone)
    end
end
